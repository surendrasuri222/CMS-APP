        ...
        <div className="border border dark rounded container-fluid w-50 shadow-lg p-3 mb-5 bg-white rounded">
            <form>
                ...
                <div className="container-fluid">
                    <NavLink to='/pages'><button className="btn btn-secondary me-2">Close</button></NavLink> <NavLink to='/pages'><button className="btn btn-primary">Edit Page</button></NavLink>
                </div>
            </form>
        </div>
    )
